...
import io.github.gnixorlando.rest.dto.AtualizacaoStatusPedidoDTO;
import io.github.gnixorlando.rest.dto.InformacaoItemPedidoDTO;
import io.github.gnixorlando.rest.dto.InformacoesPedidoDTO;
...
public class PedidoController {
    ...
    private InformacoesPedidoDTO converter (Pedido pedido) {
        return InformacoesPedidoDTO
                .builder()
                .codigo(pedido.getId())
                .dataPedido(pedido.getDataPedido().format(DateTimeFormatter.ofPattern("dd/MMM/yyyy")))
